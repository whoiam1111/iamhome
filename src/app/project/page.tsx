      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16">
          <div className="max-w-3xl space-y-6 text-base text-gray-700">
            <p>
              <span className="text-blue-500 font-bold mr-2">•</span>나를 안다는
              건, 가장 오래된 질문에 가장 솔직하게 답하는 일입니다.
            </p>
            <p>
              그래서 우리는 물음의 근원인{" "}
              <span className="font-bold">Who I am</span>을 찾습니다.
            </p>
            <p>
              지금까지의 나는 어떤 모습이었고, 앞으로의 나는 어떤 사람이 되고
              싶은가.
            </p>
            <p>
              흔들리는 마음 사이, 그 중심을 찾아가는 이 여정에 당신을
              초대합니다.
            </p>
          </div>
        </section>
        ...
        <section className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <h4 className="text-xl font-bold text-blue-500 mb-6">
                이민형 강사
              </h4>
