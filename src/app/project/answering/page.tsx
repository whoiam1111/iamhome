    ...
    return (
        <main className="w-full">
            ...
            <section className="w-full text-center px-4 py-16 bg-white">
                <h2 className="text-2xl md:text-3xl font-bold font-serif italic text-gray-800">'Today's Q.T.'</h2>
                <p className="mt-4 max-w-md mx-auto text-base md:text-lg leading-relaxed text-gray-700">
                    여러분들의 오늘은 어떠셨나요? 세상과 맞닿은 나. 오늘의 Q.T를 통하여 세상 속의 ‘나’를 찾는 시간이
                    되기를 바랍니다.
                </p>
                <p className="mt-4 max-w-md mx-auto text-base md:text-lg font-serif italic leading-relaxed text-gray-700">
                    How was your day? I'm in touch with the world. I hope it will be time to find the world's "me"
                    through Q.T. today.
                </p>
            </section>
            ...
            >
                ...
                <div className="relative text-center text-white max-w-2xl p-4 space-y-12">
                    <div>
                        <h3 className="text-lg font-semibold font-serif italic">‘Shout at me’</h3>
                        ...
                        <p className="mt-3 text-sm font-serif italic leading-relaxed">
                            ...
                            through the time to ‘shout at me’.
                        </p>
                    </div>

                    <div>
                        <h3 className="text-lg font-semibold font-serif italic">‘Who am i?’</h3>
                        <p className="mt-3 text-sm leading-relaxed">
                            스스로에 대해 얼마나 정확하게 알고 있나요? 내 마음대로 살고 싶은데, 내 마음을 모르겠다면,
                            ‘Who am i?’를 통하여 내 마음대로 살아가는 각자의 ‘Green Light’를 향해 달려가는 시간이 되기를
                            바랍니다.
                        </p>
                        <p className="mt-3 text-sm font-serif italic leading-relaxed">
                            How exactly do you know yourself? If you want to live on your own, but you don't know how
                            you feel, I hope it will be time to run toward your own ‘Green Light’, which lives on your
                            own through ‘Who am i?’
                        </p>
                    </div>
                </div>
            </section>
