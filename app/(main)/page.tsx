          ...
          >
			...
			<FadeInSection>
				<section className="w-full flex flex-col items-center py-30 bg-gray-50">
					<div className="flex flex-col gap-1 sm:gap-3 p-5 text-2xl md:text-4xl lg:text-5xl font-extrabold mb-2 sm:mb-8 text-neutral-800">
