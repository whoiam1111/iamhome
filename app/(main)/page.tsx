    ...
    return (
        <div className={`w-full h-full flex flex-col items-center`}>
            ...
            <div className="relative flex justify-center items-center h-screen sm:w-full sm:h-full mb-[120px] sm:mb-[150px]">
                ...
                <div className={`absolute text-center text-white text-shadow-xs flex flex-col animate-fadein`}>
                    <div className="text-[clamp(1rem,_2vw,_2rem)]">배움이라는 나침반을 따라</div>
                    <div className="text-[clamp(2rem,_5vw,_5rem)] font-black">&apos;진짜 나&apos;를 찾는 사람들</div>
                    <div className="text-[clamp(1rem,_2vw,_2rem)]">I AM creators&apos; team</div>
                </div>
            </div>

            <FadeInSection align={'center'}>
                <div className="p-5 w-full lg:w-[1024px] flex flex-col gap-12 mb-[120px] md:mb-[150px] text-neutral-800">
                    <div className="flex flex-col justify-center mb-6 sm:mb-12">
                        ...
                        <div className="text-base sm:text-2xl font-light">
                            I AM은 &apos;진짜 나&apos;를 찾기 위한 다양한 프로그램 및 행사를 운영하고 있습니다.
                        </div>
                    </div>
