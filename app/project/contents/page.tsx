...
const MaskIcon = () => (
    ...
    >
        ...
        />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.25 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0z" />
    </svg>
);
                ...
                <main>
                    ...
                    <section className="my-12">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="flex flex-col items-center justify-center p-6 bg-blue-50 rounded-lg hover:bg-blue-100 cursor-pointer">
                                <ChatIcon />
                                ...
                                {events.map((item) => (
                                    <Link href={`/project/contents/${item.uid}`} key={item.uid}>
                                        <div className="group cursor-pointer">
                                            ...
                                            <div className="mt-4">
                                                <p className="text-sm text-gray-500">{item.project_category}</p>
                                                <h3 className="text-lg font-bold mt-1 group-hover:text-blue-600">
                                                    {item.title}
                                                </h3>
                                                <p className="text-sm text-gray-500 mt-1">
                                                    {item.place} · {item.start_date}
                                                </p>
