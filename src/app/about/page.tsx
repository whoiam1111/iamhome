    ...
    return (
        <div className="flex flex-col items-center w-full mt-[170px] animate-fade-in">
            ...
            <div className="flex flex-col items-center gap-5 w-full bg-[#f8f8f8] py-[100px] mb-[150px] px-4">
                ...
                <div className="text-[40px] font-black mb-[50px] md:text-[35px] sm:text-[25px]">
                    &quot;I AM WHO I AM&quot;
                </div>
                ...
                <div className="flex gap-10 mb-5 flex-col md:flex-row">
                    ...
                    >
                        ...
                        <div className="p-10">
                            ...
                            <div className="text-gray-600 text-sm sm:text-xs">
                                &lsquo;진짜 나&rsquo;를 찾고, 성장할 수 있도록 강연, 훈련, 멘토링, 다양한 콘텐츠를
                                기획·운영합니다.
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="p-10">
                            ...
                            <div className="text-gray-600 text-sm sm:text-xs">
                                &lsquo;진짜 나&rsquo;를 찾고, 성장할 수 있는 체계적인 훈련 프로그램을 운영합니다. 강연,
                                코칭, 교류와 각종 프로그램을 함께 할 수 있습니다.
                            </div>
                        </div>
                    </div>
                </div>
